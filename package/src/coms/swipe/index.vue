...
<script>
import XSwipe from './swipe-menu'
import XSwipeItem from './swipe-item'
...
<style scoped>
  ...
  .x-swiper .x-default-swiper {
    width: 100%;
    height: 100%;
  }
  .x-swiper .x-default-swiper img {
    width: 100%;
  }
  ...
  .x-thum-fixed .x-thum-swiper {
    width: 100%;
    height: 100%;
  }
  .x-thum-fixed .x-thum-swiper img {
    width: 100%;
  }

  .x-thum-fixed .x-thum-swiper .current-page {
    position: absolute;
    top: 10px;
    left: 50%;
